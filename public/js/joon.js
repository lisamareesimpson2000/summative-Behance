       ...
       for (var j= 0; j < 3; j++) {
         ...
         console.log(data.projects[j]);
            ...
            var project = data.projects[j];
             ...
             if (j==0) {
              container.append('<div align="center" id="project1" style="height: 48em; width: 100%;"></div>')
            ...
            var   projContainer1 = document.getElementById('project1')
              ...
              container.append('<div align="center" id="project2" style="height: 48em; width: 100%;"></div>')
              ...
              container.append('<div align="center" id="project3" style="height: 48em; width: 100%;"></div>')
